...
AKPENE BRIGHT ALBERT -2526400957

This is my submission for Assignment 1 in the

Programming C++ for Engineers Using Arduino course at GCTU / BCE-B.
...
3. Select Tools > Board > Arduino Uno and the correct Port. 4. Click Upload, then open Tools > Serial Monitor (9600 baud).
